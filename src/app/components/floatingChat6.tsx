...
export default function FloatingChat6() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      <div
        className={`${
          isOpen ? 'block' : 'hidden'
        } bg-white bg-gradient-to-r from-purple-500 via-pink-500 rounded-2xl shadow-2xl w-[400px] h-[550px] flex flex-col p-6 transform transition-all duration-500 ease-in-out ${
          isOpen ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
        }`}
      >
        {/* Chat Header with Improved Styling */}
        <div className="bg-gradient-to-r from-purple-600 to-pink-200 p-5 w-full rounded-t-xl shadow-lg text-pink-100 flex justify-center mb-6">
          <h2 className="text-xl font-semibold">Chat with Us</h2>
          <button
            className="absolute px-1 right-4 text-gray-200 hover:text-gray-300 transition ease-in-out"
            onClick={toggleChat}
          >
