...
export default function FloatingChat3() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      <div
        className={`${
          isOpen ? 'hidden' : 'block'
        } bg-gradient-to-r from-purple-500 to-purple-700 text-white p-4 rounded-full cursor-pointer shadow-lg transition duration-300 ease-in-out transform hover:scale-110`}
        onClick={toggleChat}
      >
      ...
      >
        ...
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-xl font-semibold text-gray-800">Doctor AI Assistant</h2>
          <button
